...
public class RecipeRepository {
    ...
    private static com.example.foodrecipes.repositories.RecipeRepository instance;
    ...
    public static com.example.foodrecipes.repositories.RecipeRepository getInstance(){
        if(instance == null){
            instance = new com.example.foodrecipes.repositories.RecipeRepository();
        }
        return instance;
    }
